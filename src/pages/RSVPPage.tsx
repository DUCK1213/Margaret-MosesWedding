...
const RSVPPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-900 via-pink-900 to-rose-900 floral-pattern">
      {/* Decorative floral pattern overlay */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-0 left-0 w-64 h-64 border-l-2 border-t-2 border-rose-400 rounded-tl-full" />
        <div className="absolute top-0 right-0 w-64 h-64 border-r-2 border-t-2 border-rose-400 rounded-tr-full" />
        <div className="absolute bottom-0 left-0 w-64 h-64 border-l-2 border-b-2 border-rose-400 rounded-bl-full" />
        <div className="absolute bottom-0 right-0 w-64 h-64 border-r-2 border-b-2 border-rose-400 rounded-br-full" />
      </div>
      ...
      <div className="container mx-auto px-4 z-10 pt-28 pb-16">
        <div className="max-w-4xl mx-auto space-y-12 animate-fade-in">
          ...
          <div className="text-center space-y-8">
            <div className="inline-flex items-center gap-3 bg-rose-500/20 backdrop-blur-sm px-6 py-3 rounded-full border-2 border-rose-400">
              <Heart className="w-6 h-6 text-rose-300" />
              <p className="font-serif text-sm uppercase tracking-[0.3em] text-rose-300">
                RSVP
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
                <div className="hidden sm:block h-px w-16 bg-rose-400" />
                <p className="font-serif text-lg sm:text-xl md:text-2xl text-rose-200 italic max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link 
                to="/#rsvp" 
                className="inline-flex items-center gap-2 px-6 py-3 bg-rose-500/20 backdrop-blur-sm text-rose-300 hover:bg-rose-500/30 border-2 border-rose-400 rounded-lg transition-all hover:scale-105"
              >
          ...
          {/* Main Content */}
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 md:p-12 border-2 border-rose-400/20">
