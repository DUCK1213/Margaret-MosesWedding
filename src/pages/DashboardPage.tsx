            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
                  <path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-
2z"/>
Hanle
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Total RSVPs */}
            <div className="bg-cream/90 backdrop-blur-sm rounded-2xl shadow-xl p-6 border-2 border-gold/20">
          ...
          {/* Recent RSVPs */}
          <div className="bg-cream/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 border-2 border-gold/20">
